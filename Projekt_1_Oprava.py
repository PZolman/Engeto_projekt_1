...
print(f"Your pasword is:", (len(password,) * "*"))

# 4.vyber Textu
print(oddelovac2)
print("You can choose from three texts:")
print(oddelovac2)
...
print(oddelovac2)
if vybrany_odstavec < 1 or vybrany_odstavec > 3:
...
for i in vycistena_slova:
  # print(vyskyt_slov.setdefault(ciste_slovo, 0))
  vyskyt_slov[i] = vyskyt_slov.setdefault(i, 0) + 1

delka_slova = {}
for i in vycistena_slova:
  delka_slova[len(i)] = delka_slova.setdefault(len(i), 0) + 1

vybrana_slova = sorted(delka_slova,reverse=True)
for i in vybrana_slova:
